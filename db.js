...
// Réparation : les anciens animes avec des champs vides (NULL) ne doivent plus faire planter le site
db.exec(`
  UPDATE animes SET genres = '' WHERE genres IS NULL;
  UPDATE animes SET synopsis = '' WHERE synopsis IS NULL;
  UPDATE animes SET status = 'En cours' WHERE status IS NULL;
`);
